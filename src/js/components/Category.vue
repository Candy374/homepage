...
<template id="category">
    <section class="category justify-between direction-row">
        <div class="block" v-for="block in cate[blocks]">
            <figure>
                <img v-bind:src="'./assets/' + block.img + '.png'"/>
            </figure>
